...
//default
const defaultLibImages = [img01, img02, img03, img04, img05, img06, img07, img08, img09, img10];

export default function imgLibController(nameImgSet) {
    switch (nameImgSet) {
        case 'Hearts':
            return heartsLibImages

        default:
            return defaultLibImages
    }
}